...
class Box(TimeStampedUUIDModel):
    ...
    open_date = models.DateTimeField(default=timezone.now, help_text="Date when the gift box can be opened")
    last_opened = models.DateTimeField(blank=True, null=True, help_text="Date when the gift box was last opened")
