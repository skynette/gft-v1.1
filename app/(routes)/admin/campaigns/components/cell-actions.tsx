...
import { useAdminDeleteCampaign } from "@/lib/hooks/admin-hooks"
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
    ...
    const { mutate, isPending } = useAdminDeleteCampaign({
        onSuccess() {
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => {
                        ...
                        router.push(`/admin/campaigns/create?query=update&id=${data.id}`)
                        router.refresh()
                    }}>
