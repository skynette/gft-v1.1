...
import { GiftVisitSheet } from "./gift-visit-sheet"
import { useAdminDeleteGiftVisit } from "@/lib/hooks/admin-hooks"

interface CellActionProps {
    data: AdminGiftVisitsResponse
}
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
    ...
    const { mutate, isPending } = useAdminDeleteGiftVisit({
        onSuccess() {
