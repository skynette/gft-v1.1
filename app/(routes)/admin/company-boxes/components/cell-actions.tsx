...
import { CompanyBoxSheet } from "./company-sheet"
import { useAdminDeleteCompanyBoxes } from "@/lib/hooks/admin-hooks"

interface CellActionProps {
    data: AdminCompanyBoxResponse
}
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
    ...
    const { mutate, isPending } = useAdminDeleteCompanyBoxes({
        onSuccess() {
