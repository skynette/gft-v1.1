...
const EditCampaignForm = () => {
    const initialValues: EditCampaignValues = {
        name: '',
        company_boxes: 0,
        duration: 0,
        num_boxes: 0,
    ...
    const handleSubmit = (values: EditCampaignValues, actions: FormikHelpers<EditCampaignValues>) => {
